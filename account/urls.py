...
from .views import HomeView, About, other_user, register, profile, edit, UserRating, UserRatingView, ChatDetailView, ChatListView, MessagesDetailView, CreateDialogView
...
urlpatterns = [
    ...
    path('<int:id>/', other_user, name='other_user_profile'),
