...
from .views import product_detail, create_product, ProductListView, edit_my_product, delete_product, \
...
urlpatterns = [
    ...
    path('user_product', login_required(ProductListView.as_view()), name='user_products'),
